...
CREATE TABLE REVIEW (
    ...
    REVIEW_DATE_ADDED TIMESTAMP DEFAULT CURRENT_TIMESTAMP,   	-- Time the review was recorded
    REVIEW_DATE_UPDATED TIMESTAMP DEFAULT CURRENT_TIMESTAMP,   	-- Time the review was updated
